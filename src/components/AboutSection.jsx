    ...
    <section className="w-full py-16 md:py-20 lg:py-24" style={{ backgroundColor: colors.primary[600] }}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <div className="text-center mb-10 lg:mb-12">
          <TextAnimate as="h2" animation="fadeIn" by="word" delay={0.1} once className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight tracking-tight">
